...
Set up the Backend Mongo Express server
...
Run the React app:
npm run build
Code Engine: To run the Cloud Code Engine service to access Sentiment Analyzer Microservice:
...
Deployment
Kubernetes: Deploy the application and its microservices on Kubernetes for scalability.
IBM Cloud: Deploy the Sentiment Analyzer microservice on IBM Cloud Code Engine.
